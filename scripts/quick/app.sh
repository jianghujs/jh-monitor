...
if [ ! -d /www/server/php/74 ];then
	cd /www/server/jh-monitor/plugins/php && bash install.sh install 74
else
...
if [ ! -d /www/server/swap ];then
	cd /www/server/jh-monitor/plugins/swap && bash install.sh install 1.1
else
...
if [ ! -d /www/server/phpmyadmin ];then
	cd /www/server/jh-monitor/plugins/phpmyadmin && bash install.sh install 4.4.15
else
